...
export const connectProjects: Project[] = [
  {
    slug: "neighbourhood-cocktails",
    name: "Neighbourhood Cocktails",
    kind: "Commissioned work",
    serviceOffered: ["Website design", "SEO Optimization", "User Experience Design"],
    sector: "Beverages · Website",
    headline: "Designing a search-optimized visual library to capture organic cocktail search intent.",
    intro: "Neighbourhood Cocktails was built from scratch to turn premium cocktail culture into an organic search engine authority. We designed the experience to be visually rewarding while maintaining perfect SEO hygiene.",
    image: "/work/neighbourhood-hero.png",
    palette: "#d18a28",
    challenge: "Creating a media-rich website that loads fast enough to pass Google Core Web Vitals while capturing complex, informational search queries in a competitive beverage space.",
    approach: [
      "From-scratch interactive interface design",
      "Optimized media delivery and structured recipes",
      "Comprehensive search intent mapping",
      "Multi-point customer interaction and testing"
    ],
    outcomes: [
      "99% recorded SEO health score within 3 months",
      "Organic traffic momentum powered by search hygiene",
      "Engineered to rank in the top 2 for cocktail-related search queries within 6 months"
    ]
  },
  {
    slug: "bewama",
    name: "Bewama",
    kind: "Commissioned work",
    serviceOffered: ["Ecommerce platform", "Product catalog management"],
  ...
  },
  {
    ...
    name: "Somafix Kenya",
    kind: "Commissioned work",
    serviceOffered: ["Website design", "Content strategy"],
  ...
  },
  {
    ...
    name: "Kumbusha",
    kind: "Rotsi product",
    serviceOffered: ["Product experience design"],
  ...
  },
  {
    ...
    name: "Tena CRM",
    kind: "Rotsi product",
    serviceOffered: ["Customer relationship management"],
  ...
  },
  {
    ...
    name: "IBIZA",
    kind: "Commissioned work",
    serviceOffered: ["Internal platform development"],
  ...
  },
  {
    ...
    kind: "Studio concept",
    serviceOffered: ["Brand strategy", "Website design"],
...
export function getProject(slug: string) {
  return connectProjects.find((project) => project.slug === slug);
}