    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.footerSocial}>
          <a href="https://www.instagram.com/malaikastudios.ke/" target="_blank" rel="noopener noreferrer">
            <FaInstagram />
          </a>
          <a href="https://www.x.com/rotsilabs/" target="_blank" rel="noopener noreferrer">
            <FaTwitter />
          </a>
          <a href="https://www.linkedin.com/in/alvin-victor-/" target="_blank" rel="noopener noreferrer">
            <FaLinkedin />
          </a>
        </div>
        <div className={styles.footerBottom}>
          <span>© 2026 Malaika Studios. All rights reserved.</span>
          <span>Digital Presence by <a href="https://malaikastudios.rotsi.co.ke" target="_blank" rel="noopener noreferrer">Malaika Studios</a></span>
        </div>
      </div>
    </footer>
  );
